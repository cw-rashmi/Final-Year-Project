...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AISCM.Droid.register, AISCM.Android", register.class, __md_methods);
	}
	...
	public register ()
	{
		...
		if (getClass () == register.class)
			mono.android.TypeManager.Activate ("AISCM.Droid.register, AISCM.Android", "", this, new java.lang.Object[] {  });
	}
